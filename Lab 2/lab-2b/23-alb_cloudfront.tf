# Explanation: CloudFront is the only public doorway — BOS stands behind it with private infrastructure.
resource "aws_cloudfront_distribution" "bos_cf01" {
  ...
  viewer_certificate {
    acm_certificate_arn      = aws_acm_certificate_validation.bos_cf_acm_validation01.certificate_arn
